...
/// 14 - 飞镖命中  param: 1=前哨站,2=基地固定,3=基地随机固定,4=基地随机移动,5=基地末端移动
...
constexpr int32_t EXT_MATCH_END        = 102;  // 比赛结束  param: "red_win"/"blue_win"/"draw"
...
constexpr int32_t EXT_ROBOT_INSTANT_RESPAWN = 111;  // 金币立即复活  param: "robot_id:cost"
...
// 能量机关 (130-139)
constexpr int32_t EXT_RUNE_BUFF_EXPIRED  = 130;  // 能量机关增益过期  param: "red"/"blue"

// 科技核心 (140-149)
constexpr int32_t EXT_TECH_CORE_ASSEMBLING = 140;  // 开始装配  param: "team:difficulty"
constexpr int32_t EXT_TECH_CORE_ASSEMBLED  = 141;  // 装配成功  param: "team:difficulty"
constexpr int32_t EXT_TECH_CORE_FAILED     = 142;  // 装配失败  param: "team:difficulty"
constexpr int32_t EXT_TECH_CORE_LEVEL_UP   = 143;  // 等级上限提升  param: "team:max_level"

// 飞镖扩展 (150-159)
constexpr int32_t EXT_DART_LAUNCHED       = 150;  // 飞镖发射  param: "team:target"
constexpr int32_t EXT_DART_GATE_CLOSE     = 151;  // 飞镖闸门关闭  param: "red"/"blue"
constexpr int32_t EXT_DART_SCREEN_BLOCKED = 152;  // 飞镖遮挡  param: "team:duration_sec"

// 空中支援扩展 (160-169)
constexpr int32_t EXT_AIR_SUPPORT_END      = 160;  // 空中支援结束  param: "red"/"blue"
constexpr int32_t EXT_AERIAL_LOCKED        = 161;  // 空中机器人被锁定  param: "robot_id:duration"
...
constexpr int32_t EXT_PENALTY_WARNING = 172;  // 口头警告  param: "robot_id:reason"

// 增益 (180-189)
constexpr int32_t EXT_BUFF_GAINED           = 180;  // 增益获得  param: "robot_id:buff_type:level:duration"
constexpr int32_t EXT_BUFF_EXPIRED          = 181;  // 增益过期  param: "robot_id:buff_type"
constexpr int32_t EXT_DEFENSE_ZONE_CAPTURED = 182;  // 增益点占领  param: "robot_id:zone_type"
constexpr int32_t EXT_DEFENSE_ZONE_LOST     = 183;  // 增益点丢失  param: "robot_id:zone_type"

// 经济 (190-199)
constexpr int32_t EXT_AMMO_EXCHANGED     = 190;  // 弹药兑换  param: "robot_id:type:amount:cost"
constexpr int32_t EXT_REMOTE_HEAL        = 191;  // 远程回血  param: "robot_id:cost"
constexpr int32_t EXT_GOLD_INCOME        = 192;  // 金币收入  param: "team:amount:source"
constexpr int32_t EXT_SENTRY_SUPPLY_AMMO = 193;  // 哨兵补给弹药  param: amount

// 英雄/哨兵 (200-209)
constexpr int32_t EXT_HERO_DEPLOY_EXIT        = 200;  // 英雄退出部署模式
constexpr int32_t EXT_SENTRY_POSTURE_CHANGE   = 201;  // 哨兵切换姿态  param: posture_id

// 雷达 (210-219)
constexpr int32_t EXT_RADAR_MARK_THRESHOLD = 210;  // 雷达标记达阈值  param: "target_id:progress"
constexpr int32_t EXT_RADAR_DOUBLE_VULN    = 211;  // 雷达双倍易伤触发  无参数

// 等级 (220-229)
constexpr int32_t EXT_LEVEL_UP          = 220;  // 等级提升  param: "robot_id:new_level"
constexpr int32_t EXT_MAX_LEVEL_REACHED = 221;  // 达到等级上限  param: "robot_id:level"
...
inline const char* eventIdToName(int32_t id) {
  switch (id) {
    // 官方 1-18
    case EventId::KILL: return "击杀";
    case EventId::STRUCTURE_DESTROYED: return "建筑摧毁";
    case EventId::RUNE_CHANCE_CHANGE: return "能量机关次数变化";
    case EventId::RUNE_CAN_ACTIVATE: return "能量机关可激活";
    case EventId::RUNE_ARM_RESULT: return "能量机关臂数结果";
    case EventId::RUNE_ACTIVATED: return "能量机关被激活";
    case EventId::HERO_DEPLOY_MODE: return "英雄部署模式";
    case EventId::HERO_SNIPER_OWN: return "己方英雄狙击";
    case EventId::HERO_SNIPER_ENEMY: return "对方英雄狙击";
    case EventId::AIR_SUPPORT_OWN: return "己方空中支援";
    case EventId::AIR_SUPPORT_OWN_BROKEN: return "己方空中支援被打断";
    case EventId::AIR_SUPPORT_ENEMY: return "对方空中支援";
    case EventId::AIR_SUPPORT_ENEMY_BROKEN: return "对方空中支援被打断";
    case EventId::DART_HIT: return "飞镖命中";
    case EventId::DART_GATE: return "飞镖闸门";
    case EventId::BASE_ATTACKED: return "基地遭攻击";
    case EventId::OUTPOST_STOP_ROTATE: return "前哨站停转";
    case EventId::BASE_ARMOR_OPEN: return "基地护甲展开";
    // 扩展 101+
    case EventId::EXT_MATCH_START: return "比赛开始";
    case EventId::EXT_MATCH_END: return "比赛结束";
    case EventId::EXT_STAGE_CHANGE: return "阶段切换";
    case EventId::EXT_ROBOT_RESPAWN: return "机器人复活";
    case EventId::EXT_ROBOT_INSTANT_RESPAWN: return "立即复活";
    case EventId::EXT_TECH_CORE_ASSEMBLED: return "科技核心装配成功";
    case EventId::EXT_LEVEL_UP: return "等级提升";
    case EventId::EXT_FIRST_BLOOD: return "首杀";
    default: return "未知事件";
  }
}
